export default class {
     ...
     * @returns string
     */
    static convertCamelCaseToDash (word) {
        if (word) {
     ...
     * @return {*|{}}
     */
    static reverse2DArrays (array2D) {
        let new2DArray = []
     ...
     * @return {*}
     */
    static distanceBetweenTwoCoordinates (lng1, lat1, lng2, lat2) {
     ...
     * @param o
     */
    static buildUrlQueryParameter (o) {
        let query = ''
     ...
     * @param lowerCase
     */
    static includeStrings (text, words, lowerCase = false) {
